...
with DAG(
    ...
    merschent_staging_table_loading = PythonOperator(
        task_id='merschent_staging_table_loading',
    ...
    customer_staging_table_loding = PythonOperator(
        task_id='customer_staging_table_loding',
        python_callable=load_csv_to_snowflake,
        op_kwargs={
    ...
    fact_staging_table_loding = PythonOperator(
        task_id='fact_staging_table_loding',
        python_callable=load_csv_to_snowflake,
        op_kwargs={
...
[merschant_data_extraction>>loding_merschent_csv_into_staging>>merschent_staging_table_loading>>incremental_load_to_merchant_Dim,customer_data_extraction>>loding_customer_csv_into_staging>>customer_staging_table_loding>>incremental_load_to_customer_Dim,transaction_data_extraction>>loding_transaction_csv_into_staging>>fact_staging_table_loding]>>incremental_load_to_transaction_fact>> truncate_fact_s >>[truncate_customer_Dim_s,truncate_merchant_Dim_s]
